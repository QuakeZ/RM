...
double pos = -99,vel = -88;//pos初始位置 vel测量速度 acel 
double acel = 0;
...
////////////////////////////////////////////////////////////////////////
    ...
    ros::init(argc,argv,"positioningUV");
    ros::NodeHandle n;
    ros::Rate rate(50);
    ...
    ros::Publisher po_pub = n.advertise <geometry_msgs::Pose>("/sentry/positionUV", 1000);
